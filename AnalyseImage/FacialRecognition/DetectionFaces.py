...
def main():
    ...
    def start_video_capture(root):
        if(confirm_action() == 'yes'):            
            ...
            # Load classifiers
            face_cascade_name = os.path.join(dir_root, 'data', 'haarcascades', 'haarcascade_frontalface_alt.xml')
            eyes_cascade_name = os.path.join(dir_root, 'data', 'haarcascades', 'haarcascade_eye_tree_eyeglasses.xml')
            ...
            def take_picture():
                ...
                if ret:
                    ...
                    # Diretório raiz onde o arquivo Python está localizado
                    diretorio_raiz = os.path.dirname(os.path.abspath(__file__))
                    # Save the frame to a file (you can customize the file path)
                    save_path = diretorio_raiz + '\\captured_images\\'+ file_path;
                    print(save_path)
    ...
    start_button = tk.Button(main_frame, text="Start Video", command=lambda:start_video_capture(root))
